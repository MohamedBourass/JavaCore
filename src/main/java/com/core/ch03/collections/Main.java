package com.core.ch03.collections;
...
public class Main {
	...
	// Map: a map is a collection that maps key to values, with no duplicate keys allowed
	// Note* : Map does not implement the Collection interface but it is considered as part of the Java Collection Framework
